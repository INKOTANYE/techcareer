...
//   const findId= products.find(x => x.id === 5) 
//   console.log(findId) veya for each
...
//math kütüphanesi veya map, sort metodları kullanılabilir.

// const result=products.sort((a,b)=> b.unitPrice-a.unitPrice)[products.length-1]
// console.log(result)

//   const newArray= products.filter(x => x.unitPrice > 30 && x.categoryId !== 2)
//   console.log(newArray.length)

// const inStock= products.filter(x => x.unitsInStock === 0)
