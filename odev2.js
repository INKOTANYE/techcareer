...
// *Mayıs 1998 yılında verilen siparişlerin toplam tutarı nedir? 100854.72
...
//       obj.totalPrice += detail.quantity * detail.unitPrice
//     })

//     const result= customerTotalPrice.length > 0 ? customerTotalPrice.find(x => x.id===order.customerId):null
...
// badCustomer=customerTotalPrice.sort((a,b) => a.totalPrice-b.totalPrice)

// console.log(badCustomer[0])
