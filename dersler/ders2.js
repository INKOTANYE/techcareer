...
// const numbers= suppliers.map(s => s.address.phone.toString()
// .replace('(','')
// .replace(')','')
// .replace('-','')
// .replaceAll(' ','')
// .replaceAll('.',''))
// //string yerine number a dönüştürmek için başına + koy yeter
// console.log(numbers)

//countrysi usa olan supplierların contactnamelerini büyük harfle yazdır.

// const contacts= suppliers.map(s => s?.contactName.toUpperCase())
...
//en cok tutar olarak sıparıs veren müşteri??
