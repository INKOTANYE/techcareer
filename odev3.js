...
//     let price=p.unitPrice*p.unitsOnOrder
//     let kdv=price*1.18

//     if(p.unitsInStock < 5){
//         table.innerHTML += `<tr style="color:red;">
//         <td>${p.id}</td>
//         <td>${p.name}</td>
...
//     const year= new Date(q.orderDate).getFullYear()
//     const month= new Date(q.orderDate).getMonth()
